...
{
    public function __construct(CategoryIcon $model)
    {
        $this->moduleName = "Category Icons";
        $this->moduleRoute = url('category-icons');
        $this->moduleView = "restaurant.main.icons";
        $this->model = $model;

        $this->iconStoragePath = config("restomenu.path.storage_icon");
    ...
    {
        return view("restaurant.main.general.create");
    }

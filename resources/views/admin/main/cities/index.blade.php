            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover nowrap" id="cities-table"
                            width="100%">
                            <thead>
                                <tr>
                                    {{-- <th>{{__('No.')}}</th> --}}
...
<script>
    var citiesTable = $("#cities-table").DataTable({
    ...
    $(document).on('click', '.deleteRecord', function(event) {
        ...
        var deleteMessage = "{{ __('You want to delete this city?') }}";
        var isDelete = deleteRecordByAjax(deleteUrl, "{{$module_name}}", citiesTable, null, deleteMessage);
    });

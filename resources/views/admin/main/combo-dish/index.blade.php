        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h3>{{ __('Combo Dishes') }}</h3>
                    <a href="{{ $module_route."/create" }}" class="btn btn-xs btn-primary pull-right">{{__('Add')}}</a>
                </div>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover nowrap" id="combo-dish-table"
                            width="100%">
                            <thead>
                                <tr>
                                    <th>{{__('No.')}}</th>
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(combo_dish_image_full_path) {
                    return "<img src='" + combo_dish_image_full_path + "' class='img-thumbnail small-image'>";
                }  
            },
            {
                data: null,

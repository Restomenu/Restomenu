            ...
            <div class="ibox">
                ...
                <div class="text-center">
                    <div class="btn-group mb-3 select-visitor-type" role="group">
                        <button type="button" class="btn btn-secondary" data-type="pending">{{__('Pending')}}</button>
                        <button type="button" class="btn btn-outline-secondary" data-type="approved">{{__('Approved')}}</button>
                        <button type="button" class="btn btn-outline-secondary" data-type="all">{{__('All')}}</button>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover nowrap" id="translation-table" width="100%">
                            <thead>
                                <tr>
...
<script>
    ...
    var translationFilterValue = null;
    var translationTable = $("#translation-table").DataTable({
        ...
        ajax: {
            ...
            "data": function(d) {
                d.translationFilterValue = translationFilterValue;
            }
        },
        columns: [{
                data: 'DT_RowIndex',
    ...
    $('.select-visitor-type button').click( function() {
        ...
        translationFilterValue = $(this).data('type');
        
        
        translationTable.draw(true);
    });
</script>
@endpush
          ...
          <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff; border-radius:5px 5px 0 0;">
              <tr>
                ...
                <tr>
                    ...
                    <tr>
                    <td width="28">&nbsp;</td>
                      <td align="center" valign="middle"><a href="#"><img src="../images/logo.png" width="205" height="54" alt="Restomenu"></a></td>
                    </tr>
                    <tr>
                    </tr>
                  </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
  ...
  <tr>
  	<td><img src="../images/pic01.png" width="229" height="125" alt="Picture"></td>
  </tr>
  <tr>
  	<td height="23">&nbsp;</td>
  </tr>
  <tr>
  	<td class="heading" style="font:700 37px 'Montserrat', Helvetica, Arial, sans-serif; color:#CACC2D; text-transform:uppercase; padding:0 5% 0 5%;">HELLO $</td>
  </tr>
  <tr>
  	<td height="30">&nbsp;</td>
  </tr>
  <tr>
  	<td style="font:18px Arial, Helvetica, sans-serif; color:#3a3a3a; padding:0 5% 0 5%;">Content que tu sois à bord. <br>Veuillez activer votre compte pour profiter de toutes nos délicieuses fonctionnalités.</td>
  </tr>
  <tr>
  	<td height="30">&nbsp;</td>
  </tr>
  ...
  <tr>
  <td align="center" bgcolor="#CACC2D" style="border-radius:28px;" height="61"><a href="#" style="font:700 16px/61px 'Montserrat', Helvetica, Arial, sans-serif; color:#ffffff; text-decoration:none; display:block; overflow:hidden; outline:none;">Activation</a></td>
  </tr>
</table>
...
<!-- ----------------- Footer Start Here ------------------------- -->
  ...
  <td width="21">&nbsp;</td>
    ...
    <tr><td>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
  <tr>
    <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#383838;"><a style="color:#ffffff; text-decoration:none;" href="#"> 
Afficher dans le navigateur</a> </td>
    <td style="color:#ffffff;"> | </td>
    <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#383838;"><a style="color:#ffffff; text-decoration:none;" href="#"> Se désabonner</a> </td>
    <td style="color:#ffffff;"> | </td>

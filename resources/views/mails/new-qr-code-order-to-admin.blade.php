...
<head>
    ...
    <title>{{ config('app.name','Restomenu') }} | Register</title>
    <style type="text/css">
        /*////// RESET STYLES //////*/
        body {
                ...
                <table class="table1" width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td bgcolor="#fcfcfc" style="padding-top: 30px;padding-right: 40px;padding-bottom: 0;padding-left: 40px; border: 1px solid #f2f2f2; border-radius: 5px;">
                                ...
                                <tr>
                                    <td class="editable-img" align="center">
                                        <a href="{{env('RESTOMENU_URL')}}" target="__blank">
                                            <img editable="true" class="centerize" mc:edit="image101" src="{{ asset('admin/images/Logo.png') }}" style="display:block; line-height:0; font-size:0; border:0; max-height:75px" border="0" alt="image" />
                                        </a>
                                    </td>
                                </tr>
                                <!-- margin-bottom -->
                            ...
                            <!-- social icons -->
                            <table class="no_float" width="50%" align="right" border="0" cellspacing="0" cellpadding="0" height="80px">
                                <tr>
                                    <td>
                                        <table width="135" align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
                                            <tr>
                                                <td class="editable-img" align="center">
                                                    <a href="https://www.facebook.com/restomenu.be/" target="__blank">
                                                        <img editable="true" class="centerize" mc:edit="image104" src="{{ asset('mails/social-icon-fb.png') }}" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="image" />
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
        ...
        <tr>
            <td>
                <table class="table1" width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td bgcolor="#fcfcfc" style="padding: 40px 0;border: 1px solid #f2f2f2;border-radius: 5px;">
                            ...
                            <table class="table1" width="480" align="center" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" mc:edit="text101" class="text_color_282828" style="line-height: 1;color: #282828; font-size: 18px; font-weight: 600; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                        <div class="editable-text">
                                            <span class="text_container">{{env('APP_NAME')}} - New Qr Code Order!</span>
                                        </div>
                                    </td>
                                ...
                                <!-- email details -->
                                <tr>
                                    <td align="center" mc:edit="text102" class="text_color_c6c6c6" style="line-height: 1.8;color: #9e9e9e; font-size: 14px; font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                        <div class="editable-text">
                                            Restaurant Name : {{$restaurant_name}}<br>
                                            Restaurant email : {{$restaurant_email}}<br>
								...
								<td align="center" mc:edit="text103" class="text_color_c6c6c6" style="line-height: 1;color: #c6c6c6;font-style: italic; font-size: 14px; font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text">
										<span class="text_container">{{$data['name']}}</span>
                                </div>
                        </td>
                    </tr>
                    ...
                    {{-- <tr>
						<td align="center" mc:edit="text104" class="text_color_93c054"
							style="line-height: 1;color: #93c054; font-size: 14px;font-style: italic;font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;">
							<div class="editable-text">
								<span class="text_container">{{$data['name']}}</span>
                    </div>
            </td>

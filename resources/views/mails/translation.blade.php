							...
							<table class="table1" width="480" align="center" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td align="center" mc:edit="text101" class="text_color_282828"
										...
										<div class="editable-text">
											<span class="text_container">Welkom bij {{env('APP_NAME')}}</span>
										</div>
									</td>
								...
								<tr>
									<td align="center" mc:edit="text102" class="text_color_c6c6c6"
										...
										<div class="editable-text">
											<span class="text_container">Wij zijn blij jou te mogen vermelden bij onze
												hechte horeca familie. Hieronder
												kun je jouw account activeren.</span>
										</div>
										<div class="editable-text" style="margin-top:20px">
											<span class="text_container">Als je vragen hebt, kun je ons altijd bellen of
												mailen.</span>
										</div>
									</td>
								...
								<tr>
									<td class="editable-img" align="center">
										<a href="{{env('RESTAURANT_URL')}}" target="__blank">
											<img editable="true" mc:edit="image105"
												src="{{ asset('mails/circle-icon-user.png') }}"

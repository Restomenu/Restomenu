								...
								<tr>
									<td align="center" mc:edit="text101" class="text_color_282828"
										...
										<div class="editable-text">
											<span class="text_container">{{env('APP_NAME')}} - New Restaurant Registration Mail!</span>
										</div>
									</td>
								...
								<tr>
									<td align="center" mc:edit="text102" class="text_color_c6c6c6"
										...
										<div class="editable-text">
                                            ...
                                            Email : {{$email}}<br>
                                            Billing Email : {{$email_billing}}<br>
                                            Phone : {{$phone}} <br>
                                            Billing Phone : {{$phone_billing}}<br>
                                            Number of Employees : {{$number_of_employees}}<br>
                                            VAT Number : {{$VAT_number}} <br>
                                            Street And House Number :  {{$street_and_house_number}} <br>
                                            Province : {{$province}} <br>
                                            Phone : {{$phone}} <br>
                                            Phone Billing : {{$phone_billing}} <br>
										</div>
									</td>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
  ...
  <tr>
  	<td class="heading" style="font:700 37px 'Montserrat', Helvetica, Arial, sans-serif; color:#CACC2D; text-transform:uppercase; padding:0 5% 0 5%;">Hallo $</td>
  </tr>
  <tr>
  	<td height="30">&nbsp;</td>
  </tr>
  <tr>
  	<td style="font:18px Arial, Helvetica, sans-serif; color:#3a3a3a; padding:0 5% 0 5%;">We zijn blij je te mogen ontvangen <br> Gelieve je account te activeren om te genieten van onze héérlijke features. </td>
  </tr>
  <tr>
  	<td height="30">&nbsp;</td>
  </tr>
  ...
  <tr>
  <td align="center" bgcolor="#CACC2D" style="border-radius:28px;" height="61"><a href="#" style="font:700 16px/61px 'Montserrat', Helvetica, Arial, sans-serif; color:#ffffff; text-decoration:none; display:block; overflow:hidden; outline:none;">Activeren</a></td>
  </tr>
</table>
...
<!-- ----------------- Footer Start Here ------------------------- -->
  ...
  <td width="21">&nbsp;</td>
    ...
    <tr><td>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
  <tr>
    <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#383838;"><a style="color:#ffffff; text-decoration:none;" href="#"> Webversie</a> </td>
    <td style="color:#ffffff;"> | </td>
    <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#383838;"><a style="color:#ffffff; text-decoration:none;" href="#"> Uitschrijven</a> </td>
    <td style="color:#ffffff;"> | </td>
